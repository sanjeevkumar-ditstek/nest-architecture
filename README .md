...
Node.js (version 14 or later) npm (Node Package Manager) NestJS CLI (for scaffolding NestJS projects) Sequelize CLI (for database migrations) Docker (optional, for containerized deployment)

Project setup
$ npm install

Database Setup
$ npx typeorm-ts-node-commonjs migration:generate src/db/migrations/<table_Name> -d src/db/dataSourceLocal.ts #Generate a migration file
...
Visit NodeJs Documentaion to learn more about the nodejs
Visit mySql Documentaionto learn more about the MonogDB
Support
